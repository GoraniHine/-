...
class DrinkKiosk:
    def __init__(self, master):
        ...
        hamburger1 = PhotoImage(file = "C:/Users/OWNER/Desktop/0602종합설계/Bulgogi.png")
        hamburger2 = PhotoImage(file = "C:/Users/OWNER/Desktop/0602종합설계/Chicken.png")
        hamburger3 = PhotoImage(file = "C:/Users/OWNER/Desktop/0602종합설계/Cheese.png")
        
        sys.stdout = open('C:/Users/OWNER/Desktop/0602종합설계/output.txt','a')
        ...
        self.order_listbox = tk.Listbox(master, width=30)
    ...
    def clear_orders(self):
        ...
        self.selected_drink.set("불고기버거")
        self.quantity.set(1)
        os.system('C:/Users/Minsig/Desktop/0602종합설계/STTT.py') #다른 파일 불러오기
