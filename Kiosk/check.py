...
class DrinkKiosk:
    def __init__(self, master):
        ...
        #new
        self.run_sttt_button = tk.Button(master, text="Voice", command=self.run_sttt)
        self.run_sttt_button.grid(row=0, column=2, padx=10, pady=10)
    ...
    def run_sttt(self):
        ...
        subprocess.Popen([python_executable, "/home/minschoi/Jong0602/STT.py"])
